...
//CRC: https://quickbirdstudios.com/blog/validate-data-with-crc/
...
void main(){
	...
	uint32_t crc32 =  CRC32(data, data_length);		//function call
	printf("\nCRC Value of %x is %x ",data, crc32);	
}

//function to calculate CRC of 32 bit number, returns crc value
...
void main(){
	...
	const uint8_t data[] = {'4294967295};
	//const uint8_t data[] ={ 0xFFFFFFFF };
